...
const Post = async ({ type }: {type?: "status" | "comment"}) => {
  ...
  // const fileDetails = await getFileDetails("6914aff15c7cd75eb8ac9b5c");
  ...
  return (
    <div className="p-4 border-y-[1px] border-gray-100">
      ...
      <div className={`flex gap-4 ${type === "status" && "flex-col"}`}>
        ...
        >
          <Image path="default-image.jpg" alt="" w={100} h={100}/>
        </div>
        {/* CONTENT */}
        <div className="flex-1 flex flex-col gap-2">
          ...
          <div className="w-full flex justify-between">
            <Link href={`/`} className="flex gap-4">
              ...
              >
                <h1 className="text-md font-bold">gwej</h1>
                <span
          ...
          {/* <Image path="general/post.jpeg" alt="" w={600} h={600} className="rounded-xl"/> */}
